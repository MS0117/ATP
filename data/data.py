...
def _load_ds(data_dir):
    ...
    for split in ['train', 'val', 'test']:
        ds[split] = json.load(open(os.path.join(
            data_dir, 'random', f'{split}.json'), 'r')
        )
    return ds
...
def setup(args):
    ...
    _download_and_unpack(
        tarball_url='https://zenodo.org/records/12740403/files/leandojo_benchmark_4.tar.gz',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='./leandojo_v10_benchmark_4')
